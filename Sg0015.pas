...
uses Arquivos, Sg0000, Sg15, Sg0026, Sg07;
...
begin
   Dlg_Produto.Edit_pesquisa.Clear;
    if Dlg_Produto.ShowModal = mrOk then
      begin
        Dm.IBDS_Caixa_Outros.FieldByName('COD_DESP').AsInteger := Dlg_Produto.SQL_Pesquisa.FieldByName('CODIGO').AsInteger;
        Dm.IBDS_Caixa_Outros.FieldByName('NOME_DESP').AsString := Dlg_Produto.SQL_Pesquisa.FieldByName('NOME').AsString;
        Screen.OnActiveControlChange := ControlChange;
      end;
end;
